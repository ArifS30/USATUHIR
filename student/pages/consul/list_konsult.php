...
<div id="areaPesanTerkirim" class="d-none mb-3 mt-3">
    ...
    // tampilkan pesan berdasarkan topik pembahasan
                ...
                if ($judulKu && isset($judulKu['pengajuan_id'])) {
        ...
        // Handle the case where 'pengajuan_id' is null or empty
        // You may want to display a message or handle this scenario accordingly
                    echo ".... belum ada riwayat percakapan.";
                }
                ?>
            </div>
